...
export const SillyViewConfig = {
    ...
    default_game_state: {
        ...
        kline_context: {
            comment: "Compact K-line context for market judgment. m1 keeps the latest 8 minute candles; m1_overview contains only the close value sampled every 10 minute candles with at most 20 points; use m1_trend for the overall sampled trend. columns=[t,o,h,l,c].",
            updated_at: 0,
            updated_minute_at: 0,
            assets: []
        },
